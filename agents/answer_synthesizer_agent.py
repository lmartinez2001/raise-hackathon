...
ANSWER_SYNTHESIZER_PROMPT = (
    "You are a summarization agent that takes multiple summarized database entries with a query "
    "and produces a cohesive, natural-language answer to the user's query.\n"
    "Input: a user query and a list of summarized database entries.\n"
...
class AnswerSynthesizerAgent(ToolCallingAgent):
    def __init__(self, model_id: str = "meta-llama/Llama-3.3-70B-Instruct"):
        ...
        super().__init__(
            ...
            description="Synthesizes a complete answer from a list of summarized database entries.",
